...
const Content = forwardRef(function Content({isClickedNewProject, onClickSave, selectedProject, updateProjects}, ref, addTaskRef){
  ...
  if(isClickedNewProject){
    ...
    contentMaterial = <ProjectDesctiption selectedProject={selectedProject} updateProjects={updateProjects} addTaskRef={addTaskRef}/>;
