...
const ProjectDetails = forwardRef(function ProjectDetails({selectedProject, updateProjects, removeTask, removeProject}, ref){
  ...
  return (
    <div className="flex flex-col gap-2 mt-16 w-7/12">
      <div className="flex justify-between w-full">
        ...
        <button className="text-xs" onClick={() => removeProject(selectedProject.title)}>Delete</button>
      </div>
